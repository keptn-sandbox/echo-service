...
RUN GOOS=linux go build -ldflags '-linkmode=external' $BUILDFLAGS -v -o echo-service
...
COPY --from=builder /src/echo-service/echo-service /echo-service
